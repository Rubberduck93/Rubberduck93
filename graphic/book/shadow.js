...
// matrix for shadow projection
    ...
    pointsArray1.push(vec4( -0.5, 0.5,  -0.5, 1.0 ));
    pointsArray1.push(vec4( -0.5,  0.5,  0.5, 1.0 ));
    pointsArray1.push(vec4( 0.5, 0.5,  0.5, 1.0 ));
    pointsArray1.push(vec4( 0.5,  0.5,  -0.5, 1.0 ));

    pointsArray2.push(vec4( -1.0, 0.0,  -1.0, 1.0 ));
    pointsArray2.push(vec4( -1.5,  0.0,  0.0, 1.0 ));
    pointsArray2.push(vec4( 0.0, 0.0,  0.0, 1.0 ));
    pointsArray2.push(vec4( 0.0,  0.0,  -1.0, 1.0 ));
